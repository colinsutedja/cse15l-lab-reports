...
- I got this output because when not using an argument for the cd command, you aren't changing directories <br>
...
- The working directory when the command ran was <br>
