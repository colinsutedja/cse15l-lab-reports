...
Keys pressed: `bash t<tab> <enter>` I filled in the command `bash test.sh` by using `t<tab>` to fill the rest of the command in to run the tests with `test.sh` <br>
...
<img width="584" alt="Screen Shot 2024-02-23 at 09 18 38" src="https://github.com/colinsutedja/cse15l-lab-reports/assets/156348859/42de71de-3529-46d0-a4db-031a087dca4d"> <br>

Keys pressed: `:wq <enter>` I use the command `:wq` to save and quit <br>
<img width="583" alt="Screen Shot 2024-02-23 at 09 20 36" src="https://github.com/colinsutedja/cse15l-lab-reports/assets/156348859/ef9b3469-562d-4f63-abeb-c3ae39c427aa"> <br>

Keys pressed: `<up><up> <enter>` The `bash test.sh` command was 2 up in the search history to run the tests again to make sure it all passed <br>
<img width="311" alt="Screen Shot 2024-02-23 at 09 22 18" src="https://github.com/colinsutedja/cse15l-lab-reports/assets/156348859/ef48f5c4-3ed1-436f-bca4-1a9411fea959"> <br>
